...
<body>
	<%-- 제목, 제목+내용, 내용을 선택할 수 있는 창과 검색  내용를 입력받아 컨트롤러인 searchgetBoardList로 전달함 --%>
	<div class="br">
	...
	<div>
		<ul class="pagination">
			...
			<c:if test="${page.fprev}">
				<li class="page-item">
					<a class="page-link" href="getBoardList?num=1"><span class="sr-only">First</span></a>
				</li>
			</c:if>
			...
			<c:if test="${page.prev}">
				<li class="page-item">
					<a class="page-link" href="getBoardList?num=${page.startPageNum - 1}"><span class="sr-only">Previous</span></a>
				</li>
			</c:if>
			...
			<c:forEach begin="${page.startPageNum}" end="${page.endPageNum}" var="num">
				<li class="page-item">
					<a class="page-link" href="getBoardList?num=${num}">${num}</a>
				</li>
			</c:forEach>
			...
			<c:if test="${page.next}">
				<li class="page-item">
					<a class="page-link" href="getBoardList?num=${page.endPageNum + 1}"><span class="sr-only">Next</span></a>
				</li>
			</c:if>
			...
			<c:if test="${page.enext}">
				<li class="page-item">
					<a class="page-link" href="getBoardList?num=${page.end}"><span class="sr-only">Last</span></a>
				</li>
			</c:if>
		</ul>
	</div>
